<aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform bg-gray-50 dark:bg-gray-800 pt-16 flex flex-col">
...
<script>
    document.getElementById('toggle-sidebar').addEventListener('click', function() {
        document.getElementById('separator-sidebar').classList.toggle('w-16');
